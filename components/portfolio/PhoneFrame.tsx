...
export function PhoneFrame({ children, theme, accent, booted }: PhoneFrameProps) {
  return (
    ...
    >
      <div className="relative h-[min(92svh,900px)] w-[min(92vw,calc(min(92svh,900px)*0.48))] rounded-[3rem] border border-white/30 bg-slate-950 p-[6px] shadow-[0_36px_120px_rgba(15,23,42,0.38)] [container-type:size] sm:rounded-[3.35rem] sm:p-2 xl:h-[min(90svh,900px)] xl:w-[min(30vw,calc(min(90svh,900px)*0.48),440px)]">
